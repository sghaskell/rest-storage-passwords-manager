...
<required_reading>
@/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/domain-probes.md
@/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/gate-prompts.md
@/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/workflows/discuss-phase-power.md
