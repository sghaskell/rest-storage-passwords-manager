...
<template>
@/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/workflows/diagnose-issues.md
