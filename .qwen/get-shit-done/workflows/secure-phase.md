...
```
Task(
  prompt="Read /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/templates/SECURITY.md`
