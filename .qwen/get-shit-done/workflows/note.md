...
- **Global scope**: `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/notes/`)
...
2. Glob `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/notes/*.md` (if directory exists) — global notes
...
Global (/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/notes/` — works in any directory
