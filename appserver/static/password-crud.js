...
function ($,
    ...
    function refreshWindow() {
      ...
      //  }, 500);
        ...
        // Dispose of existing search manager to ensure fresh data
    ...
    function populateTable() {
       /*  // Initialize
        ...
        var search1 = splunkjs.mvc.Components.get("search1");

        // If no instance with id "search1" exists, create a new one
    ...
    search1.on('search:done', function(properties) {
        // Clear any existing content before rebuilding
