...
Key references:
- @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/ui-brand.md (display patterns)
- @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md" "/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/user-profiling.md`
...
Reference: @/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global QWEN.md" -- "Add profile to /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/QWEN.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/QWEN.md"
...
```bash
BACKUP_PATH="/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/USER-PROFILE.backup.md"
```
...
Your profile:    /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/commands/gsd/dev-preferences.md
  ✓ QWEN.md section       ./QWEN.md
  ✓ Global QWEN.md        /home/scott/Documents/code/rest-storage-passwords-manager/.qwen/QWEN.md
```
