...
```bash
node "/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/scott/Documents/code/rest-storage-passwords-manager/.qwen/get-shit-done/templates/retrospective.md`.
